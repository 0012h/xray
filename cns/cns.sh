...
InstallFiles() {
	...
	$download_tool_cmd cns http://wuyi-1251424646.costj.myqcloud.com/cns/${cns_UPX}/linux_${machine} || Error "cns download failed."
	$download_tool_cmd cns.init http://wuyi-1251424646.costj.myqcloud.com/cns/cns.init || Error "cns.init download failed."
	...
	if type systemctl; then
		$download_tool_cmd /lib/systemd/system/cns.service http://wuyi-1251424646.costj.myqcloud.com/cns/cns.service || Error "cns.service download failed."
